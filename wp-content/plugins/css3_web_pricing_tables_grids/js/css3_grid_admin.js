jQuery(document).ready(function($){
	...
	$(".css3_grid_less, .css3_grid_more").click(function(event){
		...
		if($(this).hasClass("css3_grid_less"))
			$(this).prev().val((parseInt($(this).prev().val())-1>0 ? parseInt($(this).prev().val())-1 : 1)).trigger("change");
		else
	...
	$("#responsive").change(function(){
		$(".css3_responsive_height").css("display", ($(this).val()=="1" ? "inline" : "none"));
	});
			...
			if($(event.target).attr("id")=="rows")
			{
				...
				if(rows>previousRows)
				{
					...
					for(var j=0; j<columns; j++)
					{
						...
						if(j==0)
							rowHtml += "<div class='css3_grid_arrows_row'><a href='#' class='css3_grid_sort_up' title='up'></a><a href='#' class='css3_grid_sort_down' title='down'></a></div><div class='css3_grid_row_config'><input class='css3_grid_short' type='text' name='heights[]' value='' /><label>height (optional in px)</label><br class='css3_responsive_height' /><input class='css3_grid_short css3_responsive_height' type='text' name='responsiveHeights[]' value='' /><label class='css3_responsive_height'>responsive height (optional)</label><br /><input class='css3_grid_short' type='text' name='paddingsTop[]' value='' /><label>padding top (optional in px)</label><input class='css3_grid_short' type='text' name='paddingsBottom[]' value='' /><label>padding bottom (optional in px)</label></div>";
						else
			...
			else
			{
				...
				for(i=previousColumns; i<columns; i++)
				{
					if(i==0)
					{
						...
						$("#textsTable tbody tr").append("<td class='css3_grid_admin_column1'><div class='css3_grid_arrows_row'><a href='#' class='css3_grid_sort_up' title='up'></a><a href='#' class='css3_grid_sort_down' title='down'></a></div><div class='css3_grid_row_config'><input class='css3_grid_short' type='text' name='heights[]' value='' /><label>height (optional in px)</label><br  class='css3_responsive_height' /><input class='css3_grid_short css3_responsive_height' type='text' name='responsiveHeights[]' value='' /><label class='css3_responsive_height'>responsive height (optional)</label><br /><input class='css3_grid_short' type='text' name='paddingsTop[]' value='' /><label>padding top (optional in px)</label><input class='css3_grid_short' type='text' name='paddingsBottom[]' value='' /><label>padding bottom (optional in px)</label></div></td>");
					}
					else
					{
